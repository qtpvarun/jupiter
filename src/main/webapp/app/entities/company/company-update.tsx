  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="proTrackApp.company.home.createOrEditLabel">
            <Translate contentKey="proTrackApp.company.home.createOrEditLabel">Create or edit a Company</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : companyEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="company-name">
                  <Translate contentKey="proTrackApp.company.name">Name</Translate>
                </Label>
                <AvField
                  id="company-name"
                  type="text"
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="company-description">
                  <Translate contentKey="proTrackApp.company.description">Description</Translate>
                </Label>
